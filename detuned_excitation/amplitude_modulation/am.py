...
def am_twocolor(tau1=5000, tau2=5000, dt=5, area1=10*np.pi, area2=10*np.pi, detuning=-5, t02=0, phase=0, rectangular=False, factor=1.0, factor2=1.0, detuning2=None, rf_energy=None):
    """
